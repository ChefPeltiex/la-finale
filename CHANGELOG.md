...
- **Charte EGOR — coopération multi-agents** : [`peltiez/docs/EGOR-charte-cooperation-multi-agents.md`](peltiez/docs/EGOR-charte-cooperation-multi-agents.md) (principes, avertissements FR/EN, HITL/SCALE) ; renvois depuis [`peltiez/docs/scale-bridge.md`](peltiez/docs/scale-bridge.md) et [`PROJECT_GENESIS.md`](PROJECT_GENESIS.md) §4.
...
- **SCALE multi-agent boundaries** : section « Modèle multi-agents : permis / pas permis » dans [`peltiez/docs/scale-protocol-v1.1.md`](peltiez/docs/scale-protocol-v1.1.md) (nuance réglementaire, schéma ASCII, synthèse FR/EN) ; renvoi court depuis [`peltiez/docs/scale-bridge.md`](peltiez/docs/scale-bridge.md) (Human-in-the-loop).

### Changed

- **Charte EGOR** : ajout du principe d’**éco-efficience cognitive et opérationnelle** (intention, délégation, charge légère, pas d’effet monde sans validation humaine ; disclaimer) — [`peltiez/docs/EGOR-charte-cooperation-multi-agents.md`](peltiez/docs/EGOR-charte-cooperation-multi-agents.md).
