...
export default function EtapeFragment({
  ...
  etape: Etape
  /**
   * Absent quand le fragment n'est pas une image.
   *
   * Toutes les opérations ne commencent pas par une photo à décoder : un
   * phénomène de ciel ou une espèce vivante ne se remettent pas au joueur
   * sous forme de vignette. Fabriquer une image pour occuper la place
  ...
  return (
    <div
      className={
        image
          ? 'grid gap-10 lg:grid-cols-[minmax(0,1fr)_22rem] lg:gap-14'
          : 'mx-auto max-w-2xl'
      }
    >
      {image ? (
